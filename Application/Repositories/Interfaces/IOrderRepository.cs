...
namespace Application.Repositories.Interfaces
{
    ...
    {
        Task<(IEnumerable<Order> orders, int count, int processingCount)> GetAllAdminAsync(OrderRequestParametersAdmin p, bool trackChanges, CancellationToken ct = default);
